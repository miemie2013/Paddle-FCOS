...
def eval(_decode, eval_fetch_list, images, eval_pre_path, anno_file, eval_batch_size, _clsid2catid, draw_image, draw_thresh=0.0):
    ...
    for i, im in enumerate(images):
        ...
        result_image, result_boxes, result_scores, result_classes = _decode.detect_batch(batch_img, eval_fetch_list, draw_image=draw_image, draw_thresh=draw_thresh)
        k = 0
